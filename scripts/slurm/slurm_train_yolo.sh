...
#SBATCH --output=/hpc/gpfs2/home/u/michalek/arlab_cv_training/logs/training/train_yolo_%j.out
#SBATCH --error=/hpc/gpfs2/home/u/michalek/arlab_cv_training/logs/training/train_yolo_%j.err
...
# Note: if no CLI args are provided, `train_models.py` uses its own defaults for `--model`, `--dataset`, and `--augmentation`.
srun python3 scripts/local/train_models.py
