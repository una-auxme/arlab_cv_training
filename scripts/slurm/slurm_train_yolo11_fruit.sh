...
#SBATCH --job-name=yolo11n-seg-fruit
...
# Führe das YOLO Training aus mit yolo11n-seg Modell auf fruit_dataset_640
...
srun python3 scripts/local/train_models.py --model yolo11n-seg --dataset fruit_dataset_640
